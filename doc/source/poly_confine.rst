...
.. math::
    ...
    & = &
    \frac{4 a^{-6}}{\mathcal{N}_{\mathrm{free}}}
    \int_{0}^{a} dR R^{2}
    ...
    \right] \\
    & = &
    \frac{4}{\mathcal{N}_{\mathrm{free}}}
    \sum_{n = 1}^{\infty}
    \sum_{n_{0} = 1}^{\infty}
    \frac{(-1)^{n}}{(n \pi)}
    \frac{(-1)^{n_{0}}}{(n_{0} \pi)}
...
.. math::
    ...
    & = &
    \frac{4 a^{-6}}{\mathcal{N}_{\mathrm{surf}}}
    \sum_{n = 1}^{\infty}
    \sum_{n_{0} = 1}^{\infty}
    ...
    \right] \\
    & = &
    \frac{4\epsilon^{2} a^{-10}}{\mathcal{N}_{\mathrm{surf}}}
    \sum_{n = 1}^{\infty}
    \sum_{n_{0} = 1}^{\infty}
    (-1)^{n}(n \pi)
    (-1)^{n_{0}}(n_{0} \pi)
...
.. math::
    ...
    R_{\Delta}^{2}
    \rangle_{\mathrm{surf}} =
    \frac{16 \pi \epsilon^{2} a^{-5}}{\mathcal{N}_{\mathrm{surf}}}
    \sum_{n = 1}^{\infty}
    \sum_{n_{0} = 1}^{\infty}
    (-1)^{n}(n \pi)
    (-1)^{n_{0}}(n_{0} \pi)
